...
|-----------|-------------|
| **Bastion** | Linux (amd64/arm64), `groot` binary (≥ v1.0.1), kubeconfig to cluster API, SSH keypair, outbound SSH to relay allowed |
...
# Linux (deb)
curl -sL https://github.com/hrodrig/groot/releases/download/v1.0.1/groot_v1.0.1_linux_amd64.deb -o /tmp/groot.deb
