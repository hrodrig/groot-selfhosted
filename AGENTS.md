...
- **GROOT product:** [github.com/hrodrig/groot](https://github.com/hrodrig/groot) — pin **`v0.7.0`** for docs and chart defaults.
- **Image:** `ghcr.io/hrodrig/groot:0.7.0` (or `:v0.7.0` tag from Releases).
