...
- **GROOT product:** [github.com/hrodrig/groot](https://github.com/hrodrig/groot) — pin **`v1.0.6`** for docs and chart defaults.
- **Image:** `ghcr.io/hrodrig/groot:1.0.6` (or `:v1.0.6` tag from Releases).
