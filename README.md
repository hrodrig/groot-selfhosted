...
[![Version](https://img.shields.io/badge/version-0.2.7-blue)](./VERSION)
...
**Upstream pin:** `ghcr.io/hrodrig/groot:1.0.3` · [SPEC](https://github.com/hrodrig/groot/blob/main/SPECIFICATIONS.md) · [sample config](https://github.com/hrodrig/groot/blob/main/configs/groot.yml.sample)
